...
// Removed JUnit 5 imports since you're using JUnit 4
...
public class Part3PoeTest {
    ...
    // Fixed implementation of isValidPassword for testing
    private static boolean isValidPassword(String password) {
        return password != null && password.length() >= 8 && 
               password.matches(".*\\d.*") && password.matches(".*[!@#$%^&()]+.*");
    }

    // Removed unsupported methods that were throwing UnsupportedOperationException
    // These should be implemented based on your actual requirements:
    
    /*
    void addMessage(String message, String recipient) {
        // Implementation needed
    }

    Object getMessagesByRecipient(String recipient) {
        // Implementation needed
        return null;
    }
    ...
    String getMessageHash(String messageText) {
        // Implementation needed
        return null;
    }
    ...
    */
    ...
    public static class Message {
        ...
        public String createMessageHash() {
            return messageId.substring(0, 2) + Math.abs(messageText.hashCode());
        }
